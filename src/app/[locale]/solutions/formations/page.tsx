    ...
    features: [
      {
        ...
        description: 'Perfil estratégico, posicionamiento diferenciador, prospección estructurada, Sales Navigator y estrategia de contenido avanzada. Desde 236€ hasta 608€.',
      },
      {
        icon: 'meta',
        title: 'Meta, TikTok y Google — Generación de leads',
        description: 'Algoritmos, contenido orgánico, publicidad, retargeting, embudos de conversión y máquina de leads automatizada. Desde 236€ hasta 1104€.',
      },
      {
        icon: 'ai',
        title: 'Inteligencia Artificial — Estrategia y Transformación',
        description: 'Formación avanzada orientada a la integración concreta de la IA en los procesos de negocio. Transformación operacional, no simple descubrimiento de herramientas. 856€.',
      },
      {
        icon: 'custom',

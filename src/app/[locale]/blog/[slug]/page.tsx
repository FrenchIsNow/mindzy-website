        ...
        <div className="container-wide mb-12">
          <div className="aspect-[21/9] bg-gray-50 rounded-2xl lg:rounded-3xl overflow-hidden relative">
            {post.image.endsWith('.svg') ? (
              ...
              <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-violet-50 via-cream-50 to-violet-50/30">
                <svg className="w-20 h-20 text-violet/15" fill="none" stroke="currentColor" viewBox="0 0 24 24">

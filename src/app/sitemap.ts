...
const staticPages = [
  ...
  { path: '/pourquoi-nous', priority: 0.7, changeFrequency: 'monthly' as const },
  ...
  { path: '/academy', priority: 0.6, changeFrequency: 'weekly' as const },
  { path: '/examples-by-profession', priority: 0.5, changeFrequency: 'monthly' as const },
]

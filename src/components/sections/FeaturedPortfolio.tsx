...
export function FeaturedPortfolio({ locale }: { locale: Locale }) {
  ...
  const content = {
    fr: {
      ...
      subtitle: 'Découvrez les sites web que nous avons créés pour des thérapeutes comme vous.',
    ...
    en: {
      ...
      subtitle: 'Discover the websites we\'ve created for therapists like you.',
    ...
    es: {
      ...
      subtitle: 'Descubre los sitios web que hemos creado para terapeutas como tú.',

...
**Setup:**
1. Register at workspace.google.com
2. Enter your domain name (or purchase one directly)
3. Add MX records to your domain's DNS settings (Google provides the exact values)
...
- `firstname@yourdomain.com` — personal communications
- `invoices@yourdomain.com` — accounting separation (optional)

### For small teams
- `firstname.lastname@yourdomain.com` — personal accounts
- `hello@yourdomain.com` or `contact@yourdomain.com` — general enquiries
- `support@yourdomain.com` — customer service
- `accounts@yourdomain.com` — finance
...
3. Enable Gmail's import feature to transfer existing emails
4. Update your email signature with the new address
5. Update your email address on all platforms, supplier accounts, and client databases
6. Set up auto-forwarding from your old Gmail for a transition period

Need your professional email configured and your domain set up correctly? Our [Mindzy team handles complete website and email setup](https://mindzy.me/en/creation-site-web/). [Get started](https://mindzy.me/en/contact/).

**Further reading:**
- [How to choose your domain name](https://mindzy.me/en/blog/choisir-nom-de-domaine/)
